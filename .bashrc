...
/home/jpf/scripts/inspo_bash | lolcat
...
#if [[ $- =~ .*i.* ]]; then bind '"\C-xk": "\C-a hh -k \C-j"'; fi[ -r /home/syl0pt/.byobu/prompt ] && . /home/syl0pt/.byobu/prompt   #byobu-prompt#

[ -f ~/.fzf.bash ] && source ~/.fzf.bash
export FZF_DEFAULT_OPS="--extended"
export PATH=/home/jpf/scripts:$PATH

alias emacs="emacsclient -c -a 'emacs'"

export NNN_PLUG='p:preview-tabbed;f:fzopen;i:imgview;d:bookmarks;t:preview-tui'
export NNN_PLUG
...
#for customized bars to terminal path. 
#source: https://raw.githubusercontent.com/ChrisTitusTech/scripts/master/fancy-bash-promt.sh
##  FUNCTIONS 
